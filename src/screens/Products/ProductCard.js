        ...
        >
            ...
            <View style={{ justifyContent: 'space-between', marginLeft: 10, flex: 1 }}>
                <View>
                    ...
                    <Text style={{ fontFamily: 'Poppins-LightItalic', fontSize: 13, color: isEnabled ? '#23233C' : '#A5A5A5' }}>Vegetables</Text>
                </View>
                <Text style={{ fontFamily: 'Poppins-ExtraBold', fontSize: 14, color: isEnabled ? '#089321' : '#A5A5A5' }} > ₹ 48</Text>
            </View>
            ...
            <View style={{flex:0.7, alignItems:'flex-end', justifyContent:'center'}}>
                <CommonTexts label={item?.status} color={item?.status === 'Approved' ? '#3FB415' : '#B48415'}/> 
            </View>  }
